 ...
 */
 ...
 export class PublishFormDefaults {
      ...
      * @static
      */
     public static commitMessage: string = "Culturize Import";

     /**
      * Default Pull Request title
      * @static
      */
     public static pullrequestTitle: string = "Culturize Import";

     /**
      * Default Pull Request body.
      * @static
      */
     public static pullrequestBody: string = "This pull request was automatically generated by the Culturize App";
 }
 ...
 export class PublishOptions {
      ...
      * In short: no spaces allowed, only letters/numbers and underscores. Don't begin the path or
      * end it with slashes. Only use one forward slash '/' for multiple subdirectories.
      *
      ...
      * @static
      */
     public static baseSubdir: string = "";
 }
 ...
 export class HTAccessConf {
      ...
      * @static
      */
     public static redirectionCode: number = 302;
      ...
      * @static
      */
     public static caseInsensitiveRedirs: boolean = true;
      ...
      * @static
      */
     public static noEscape: boolean = true;
 }
